     ...
     <div class="container-fluid head-img">
          <div class="flex-container">
               <div class="container" style="padding: 3%;">
                    <center><h1 style="font-weight: 700;border-bottom:3px solid #000;width:120px;">Cart</h1></center>
               </div>
          </div>
     </div><br><br>
     ...
     <div class="container" id="rec">
          <div class="col-sm-12">
               <div class="row">
				...
				?>
					<div class="card container col-sm-5" style="margin:10px 15px;padding: 15px 0;" id="d-<?php echo $rd->code;?>">
						<div class="container row">
							...
							<div class="col-sm-8">
								...
								<h5><?php echo $row->price; ?> &nbsp;<span style="font-size:12px;font-weight: 500;"><s><?php echo $row->mrp; ?></s></span></h5><br>
								<button class="w3-button w3-small w3-blue"><a href="<?php echo base_url()."index.php/Welcome/view_book/".$row->code;?>" style="color: white;">View More</a></button>
								<button class="w3-button w3-small w3-red" rel="<?php echo $rd->code;?>">Delete</button></center>
								<script>
									$(document).on("click",".w3-red",function(){
										var e = $(this).attr("rel");
										$.post(
											"<?php echo base_url()."index.php/Welcome/delete_cart"?>",{code:e},function(data){
												if(data.trim()=="success"){
													$("#msg").html("<h5 class='alert alert-success' >Book removed from Cart ! <i class='bx bx-x' style='float:right;'></i></h5>");
													$("#d-"+e).fadeOut(1000);
												}else{
					...
					if($flag==0){
						?>
						<p>no book added in cart till now.</p>
						<?php
					}
					if($page==0 && $id>0){
						redirect(base_url()."index.php/Welcome/cart_view");
					}
					?>
					</div><br>
				</div>
