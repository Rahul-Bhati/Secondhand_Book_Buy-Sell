     ...
     <div class="container">
          <div class="col-sm-12">
               <div class="row">
                    ...
                    <div class="col-sm-8 w3-card-2">
                         <div class="row">
                              <?php
                              if($this->uri->segment(4)=="again"){
                              ?>
                              ...
                              ?>
                              <div class="col-sm-4">
                              	<center><img src="<?php echo base_url()."uploads/".$row->code.".png";?>" alt="" style="width: 200px; margin-top:20px;" class="img-fluid">
                                   <button class="w3-button w3-small w3-yellow" style="margin-top: 10px;">
                                        <a style="font-size:10px;" href="<?php echo base_url()."index.php/Welcome/Edit_img/".$row->code;?>">Change Image</a>
                                   </button></center>
                              </div>
                              <div class="col-sm-8">
                              <form action="<?php echo base_url().'index.php/Welcome/update/'.$code; ?>" method="post">
                              <div class="user-details">
                                   ...
                                   <div class="input-box">
                                        ...
                                        <textarea type="text" row=3 name="detail" value="" required><?php echo $row->detail?></textarea>
                                   </div>
                                   <div class="input-box">
