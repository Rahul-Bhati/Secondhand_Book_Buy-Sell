          ...
          <div class="col-sm-12">
               <div class="row">
				...
				<div class="col-sm-6 w3-card">
                         <div class="container">
                              <h4 style="font-weight: 700;">Update Book Image</h4><br>
                              <?php echo $error;?>
                              <?php 
                                   $code = $this->uri->segment(3);
                                   echo form_open_multipart(base_url()."index.php/Welcome/update_img/$code");?>
                              <input type="file" name="userfile" size="20" class="form-control"/><br/>
                              <input type="submit" class="w3-button w3-small w3-yellow" value="Change Image" /><br>
                              </form><br>
                         </div>
				</div>
                    <div class="col-sm-3"></div>
