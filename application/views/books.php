	...
	<div class="container-fluid head-img">
          <div class="flex-container">
               <div class="container" style="padding: 3%;">
                    <center><h1 style="font-weight: 700;border-bottom:3px solid #000;width:120px;">Books</h1></center>
               </div>
          </div>
     </div><br><br>
					...
					<div class="card container col-sm-5" style="margin:10px 15px;padding: 15px 0;">
						<div class="container row">
							...
							<div class="col-sm-8">
								...
								<button class="w3-button w3-small w3-blue"><a href="<?php echo base_url()."index.php/Welcome/view_book/".$row->code;?>" style="color: white;">View More</a></button></center>
							</div>
						</div>
					</div>
					<?php
